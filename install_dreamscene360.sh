#!/bin/bash
set -e
ENGINE_DIR="/workspace/ComfyUI/custom_nodes/comfyui-Dreamscene360/dreamscene360_engine"
...
cd "$ENGINE_DIR"
pip install submodules/diff-surfel-rasterization --break-system-packages --no-build-isolation -q 2>&1 | tail -3
